...
static const char short_gen209[] = "**getaddrinfo";
...
static const char short_gen226[] = "**inet_pton";
static const char long_gen226[]  = " inet_pton failed";
...
static const char short_gen817[] = "**sharpcoll";
static const char long_gen817[]  = "SHARP collective failed.";
static const char short_gen818[] = "**shm_open";
static const char long_gen818[]  = "unable to open a shared memory object";
static const char short_gen819[] = "**shmctl";
static const char long_gen819[]  = "failed to mark the sysv segment for removal";
static const char short_gen820[] = "**shmw_badhnd";
static const char long_gen820[]  = " Invalid handle to shared memory";
static const char short_gen821[] = "**shmw_deserbufbig";
static const char long_gen821[]  = " Size of buffer to deserialize shared memory handle  is too big (> MPIU_SHMW_GHND_SZ) ";
static const char short_gen822[] = "**shmw_gethnd";
static const char long_gen822[]  = " Unable to get shared memory handle";
static const char short_gen823[] = "**shmw_sethnd";
static const char long_gen823[]  = " Unable to set shared memory handle";
static const char short_gen824[] = "**shutdown";
static const char long_gen824[]  = "shutdown failed";
static const char short_gen825[] = "**signal";
static const char long_gen825[]  = "signal() failed";
static const char short_gen826[] = "**snprintf";
static const char long_gen826[]  = "snprintf returned an invalid number";
static const char short_gen827[] = "**sock_accept";
static const char long_gen827[]  = "accept of socket fd failed";
static const char short_gen828[] = "**sock_close";
static const char long_gen828[]  = " unable to close a socket";
static const char short_gen829[] = "**sock_closed";
static const char long_gen829[]  = "socket closed";
static const char short_gen830[] = "**sock_connect";
static const char long_gen830[]  = "connect failed";
static const char short_gen831[] = "**sock_create";
static const char long_gen831[]  = "unable to create a socket";
static const char short_gen832[] = "**sock_gethost";
static const char long_gen832[]  = "gethostname failed";
static const char short_gen833[] = "**sock_init";
static const char long_gen833[]  = "unable to initialize the sock library";
static const char short_gen834[] = "**sock_nop_accept";
static const char long_gen834[]  = "accept called without having received an op_accept";
...
static const char short_gen838[] = "**socket";
static const char long_gen838[]  = "WSASocket failed";
...
static const char short_gen854[] = "**sock|getport";
static const char long_gen854[]  = "failed to obtain port number of the listener";
...
static const char long_gen866[]  = "MPIU_Malloc failed to allocate memory for an event queue structure";
...
static const char short_gen905[] = "**unknown";
static const char long_gen905[]  = "Unknown error.  Please file a bug report.";
static const char short_gen906[] = "**unknowngpid";
static const char long_gen906[]  = "Internal MPI error: Unknown gpid";
static const char short_gen907[] = "**unsupporteddatarep";
static const char long_gen907[]  = "Only native data representation currently supported";
static const char short_gen908[] = "**unweightedboth";
static const char long_gen908[]  = "Must specify MPI_UNWEIGHTED for both or neither weight arguments";
static const char short_gen909[] = "**user";
static const char long_gen909[]  = "user defined function returned an error code";
static const char short_gen910[] = "**vc_in_error_state";
static const char long_gen910[]  = "Connection is in error state";
static const char short_gen911[] = "**vmsplice";
static const char long_gen911[]  = "vmsplice failed";
static const char short_gen912[] = "**win";
static const char long_gen912[]  = "Invalid MPI_Win";
static const char short_gen913[] = "**winInvalidOp";
static const char long_gen913[]  = " Invalid RMA operation";
static const char short_gen914[] = "**windeserialize";
static const char long_gen914[]  = "deserializing win object";
static const char short_gen915[] = "**windows_mutex";
static const char long_gen915[]  = "Windows mutex routine failed";
static const char short_gen916[] = "**winflavor";
static const char long_gen916[]  = " Window flavor is not compatible with the given operation";
static const char short_gen917[] = "**winget_oob";
static const char long_gen917[]  = "source pointer for win_get is out of bounds";
static const char short_gen918[] = "**winnoprogress";
static const char long_gen918[]  = " Detected an error while in progress wait for RMA messages";
static const char short_gen919[] = "**winnull";
static const char long_gen919[]  = "Null MPI_Win";
static const char short_gen920[] = "**winput_oob";
static const char long_gen920[]  = "target pointer for win_put is out of bounds";
static const char short_gen921[] = "**winserialize";
static const char long_gen921[]  = "serializing win object";
...
static const char short_gen925[] = "**wsasock";
static const char long_gen925[]  = "WSAStartup failed";
static const char short_gen926[] = "**wsastartup";
static const char long_gen926[]  = " WSAStartup failed";

static const int generic_msgs_len = 927;
...
static const char short_spc71[] = "**getaddrinfo %s %d";
static const char long_spc71[]  = "getaddrinfo failed, %s (errno %d)";
...
static const char short_spc81[] = "**inet_pton %s %d";
static const char long_spc81[]  = " inet_pton failed, %s (errno %d)";
...
static const char short_spc560[] = "**sharpcoll %s %d";
static const char long_spc560[]  = "SHARP collective failed with error %s (%d).";
static const char short_spc561[] = "**shm_open %s %d";
static const char long_spc561[]  = "unable to open shared memory object %s (errno %d)";
static const char short_spc562[] = "**shutdown %s %d";
static const char long_spc562[]  = "shutdown failed, %s (errno %d)";
static const char short_spc563[] = "**signal %s";
static const char long_spc563[]  = "signal() failed: %s";
static const char short_spc564[] = "**snprintf %d";
static const char long_spc564[]  = "snprintf returned %d";
static const char short_spc565[] = "**sock_accept %s";
static const char long_spc565[]  = "accept of socket fd failed - %s";
static const char short_spc566[] = "**sock_accept %s %d";
static const char long_spc566[]  = "accept failed, %s (errno %d) ";
static const char short_spc567[] = "**sock_close %s %d";
static const char long_spc567[]  = " close of socket failed, %s (errno %d)";
static const char short_spc568[] = "**sock_connect %d %s";
static const char long_spc568[]  = "connect failed - %s (errno %d)";
static const char short_spc569[] = "**sock_connect %s %d";
static const char long_spc569[]  = "connect failed - %s (errno %d)";
static const char short_spc570[] = "**sock_connect %s %d %s %d";
static const char long_spc570[]  = "unable to connect to %s on port %d, %s (errno %d)";
static const char short_spc571[] = "**sock_create %s %d";
static const char long_spc571[]  = "unable to create a socket, %s (errno %d)";
static const char short_spc572[] = "**sock_gethost %s %d";
static const char long_spc572[]  = "gethostname failed, %s (errno %d)";
static const char short_spc573[] = "**sock_read %s %d";
static const char long_spc573[]  = "read from socket failed, %s (errno %d)";
static const char short_spc574[] = "**sock_write %s %d";
static const char long_spc574[]  = " Unable to write to a socket, %s (errno %d)";
static const char short_spc575[] = "**socket %s %d";
static const char long_spc575[]  = "WSASocket failed, %s (errno %d)";
static const char short_spc576[] = "**sock|badiovn %d %d %d";
static const char long_spc576[]  = "size of iov is invalid (set=%d,sock=%d,iov_n=%d)";
static const char short_spc577[] = "**sock|badlen %d %d %d %d";
static const char long_spc577[]  = "bad length parameter(s) (set=%d,sock=%d,min=%d,max=%d)";
static const char short_spc578[] = "**sock|badport %d";
static const char long_spc578[]  = "port number is out of range (sock=%d)";
static const char short_spc579[] = "**sock|close_cancel %d %d";
static const char long_spc579[]  = "operation cancelled because sock was closed locally (set=%d,sock=%d)";
static const char short_spc580[] = "**sock|closing %d %d";
static const char long_spc580[]  = "sock is in the process of being closed locally (set=%d,sock=%d)";
static const char short_spc581[] = "**sock|closing_already %d %d";
static const char long_spc581[]  = "a close operation is already post (set=%d,sock=%d)";
static const char short_spc582[] = "**sock|connclosed %d %d";
static const char long_spc582[]  = "connection closed by peer (set=%d,sock=%d)";
static const char short_spc583[] = "**sock|listener_bad_sock %d %d";
static const char long_spc583[]  = "supplied sock is not a listener (set=%d,sock=%d)";
static const char short_spc584[] = "**sock|listener_bad_state %d %d %d";
static const char long_spc584[]  = "supplied listener sock is in a bad state (set=%d,sock=%d,state=%d)";
static const char short_spc585[] = "**sock|listener_read %d %d";
static const char long_spc585[]  = "read operation not allowed on a listener (set=%d,sock=%d)";
static const char short_spc586[] = "**sock|listener_write %d %d";
static const char long_spc586[]  = "write operation not allowed on a listener (set=%d,sock=%d)";
static const char short_spc587[] = "**sock|notconnected %d %d";
static const char long_spc587[]  = "sock is not connected (set=%d,sock=%d)";
static const char short_spc588[] = "**sock|osnomem %s %d %d";
static const char long_spc588[]  = "operating system routine %s failed due to lack of memory (set=%d,sock=%d)";
static const char short_spc589[] = "**sock|poll|accept %d %s";
static const char long_spc589[]  = "accept failed to acquire a new socket (errno=%d:%s)";
static const char short_spc590[] = "**sock|poll|badbuf %d %d %d %s";
static const char long_spc590[]  = "the supplied buffer contains invalid memory (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc591[] = "**sock|poll|badhandle %d %d %d";
static const char long_spc591[]  = "sock contains an invalid file descriptor (set=%d,sock=%d,fd=%d)";
static const char short_spc592[] = "**sock|poll|badhandle %d %d %d %d";
static const char long_spc592[]  = "sock contains an invalid file descriptor (set=%d,sock=%d,fd=%d:%d)";
static const char short_spc593[] = "**sock|poll|bind %d %d %s";
static const char long_spc593[]  = "unable to bind socket to port (port=%d,errno=%d:%s)";
static const char short_spc594[] = "**sock|poll|connclosed %d %d %d %s";
static const char long_spc594[]  = "connection closed by peer (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc595[] = "**sock|poll|connfailed %d %d %d %s";
static const char long_spc595[]  = "connection failure (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc596[] = "**sock|poll|connrefused %d %d %s";
static const char long_spc596[]  = "connection refused (set=%d,sock=%d,host=%s)";
static const char short_spc597[] = "**sock|poll|eqfail %d %d %d";
static const char long_spc597[]  = "fatal error: failed to enqueue an event; event was lost (set=%d,sock=%d,op=%d)";
static const char short_spc598[] = "**sock|poll|getport %d %s";
static const char long_spc598[]  = "failed to obtain port number of listener (errno=%d:%s)";
static const char short_spc599[] = "**sock|poll|listen %d %s";
static const char long_spc599[]  = "listen() failed (errno=%d:%s)";
static const char short_spc600[] = "**sock|poll|nodelay %d %s";
static const char long_spc600[]  = "unable to set TCP no delay attribute on socket (errno=%d:%s)";
static const char short_spc601[] = "**sock|poll|nonblock %d %s";
static const char long_spc601[]  = "unable to set socket to nonblocking (errno=%d:%s)";
static const char short_spc602[] = "**sock|poll|oserror %d %d %d %s";
static const char long_spc602[]  = "unexpected operating system error (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc603[] = "**sock|poll|oserror %d %s";
static const char long_spc603[]  = "unexpected operating system error (errno=%d:%s)";
static const char short_spc604[] = "**sock|poll|oserror %s %d %d %d %s";
static const char long_spc604[]  = "unpected operating system error from %s (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc605[] = "**sock|poll|osnomem %d %d %d %s";
static const char long_spc605[]  = "operating system routine failed due to lack of memory (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc606[] = "**sock|poll|pipe %d %s";
static const char long_spc606[]  = "unable to allocate pipe to wakeup a blocking poll() (errno=%d:%s)";
static const char short_spc607[] = "**sock|poll|pipenonblock %d %s";
static const char long_spc607[]  = "unable to set wakeup pipe to nonblocking (errno=%d:%s)";
static const char short_spc608[] = "**sock|poll|reuseaddr %d %s";
static const char long_spc608[]  = "unable to set reuseaddr attribute on socket (errno=%d:%s)";
static const char short_spc609[] = "**sock|poll|setrcvbufsz %d %d %s";
static const char long_spc609[]  = " unable to set the receive socket buffer size (size=%d,errno=%d:%s)";
static const char short_spc610[] = "**sock|poll|setsndbufsz %d %d %s";
static const char long_spc610[]  = " unable to set the send socket buffer size (size=%d,errno=%d:%s)";
static const char short_spc611[] = "**sock|poll|socket %d %s";
static const char long_spc611[]  = "unable to obtain new socket (errno=%d:%s)";
static const char short_spc612[] = "**sock|poll|unhandledstate %d";
static const char long_spc612[]  = "encountered an unexpected state (%d)";
static const char short_spc613[] = "**sock|poll|unhandledtype %d";
static const char long_spc613[]  = "encountered an unexpected sock type (%d)";
static const char short_spc614[] = "**sock|reads %d %d";
static const char long_spc614[]  = "attempt to perform multiple simultaneous reads (set=%d,sock=%d)";
static const char short_spc615[] = "**sock|writes %d %d";
static const char long_spc615[]  = "attempt to perform multiple simultaneous writes (set=%d,sock=%d)";
static const char short_spc616[] = "**stride %d %d %d";
static const char long_spc616[]  = "Range (start = %d, end = %d, stride = %d) does not terminate";
static const char short_spc617[] = "**subarrayoflow %L";
static const char long_spc617[]  = "Total size of array_of_sizes[] is %L which requires the MPI implementation to use a 64-bit MPI_Aint";
static const char short_spc618[] = "**tag %d";
static const char long_spc618[]  = "Invalid tag, value is %d";
static const char short_spc619[] = "**tempnam %d %s";
static const char long_spc619[]  = "tempnam failed - errno %d (%s)";
static const char short_spc620[] = "**toomanycomm %d %d %d";
static const char long_spc620[]  = "Too many communicators (%d/%d free on this process; ignore_id=%d)";
static const char short_spc621[] = "**toomanycommfrag %d %d %d";
static const char long_spc621[]  = " Cannot allocate context ID because of fragmentation (%d/%d free on this process; ignore_id=%d)";
static const char short_spc622[] = "**topotoolarge %d %d";
static const char long_spc622[]  = "Topology size %d is larger than communicator size (%d)";
static const char short_spc623[] = "**truncate %d %d";
static const char long_spc623[]  = "Message truncated; %d bytes received but buffer size is %d";
static const char short_spc624[] = "**truncate %d %d %d %d";
static const char long_spc624[]  = "Message from rank %d and tag %d truncated; %d bytes received but buffer size is %d";
static const char short_spc625[] = "**typeinitbadmem %d";
static const char long_spc625[]  = "%dth builtin datatype handle references invalid memory";
static const char short_spc626[] = "**typeinitfail %d";
static const char long_spc626[]  = "Did not initialize name for all of the predefined datatypes (only did first %d)";
static const char short_spc627[] = "**typematchsize %s %d";
static const char long_spc627[]  = "No MPI datatype available for typeclass %s and size %d";
static const char short_spc628[] = "**typenamelen %d";
static const char long_spc628[]  = "Specified datatype name is too long (%d characters)";
static const char short_spc629[] = "**unknowngpid %d %d";
static const char long_spc629[]  = "Internal MPI error: Unknown gpid (%d)%d";
static const char short_spc630[] = "**usercancel %d";
static const char long_spc630[]  = "user request cancel function returned error code %d";
static const char short_spc631[] = "**usercopy %d";
static const char long_spc631[]  = "user copy function returned error code %d";
static const char short_spc632[] = "**userdel %d";
static const char long_spc632[]  = "user delete function returned error code %d";
static const char short_spc633[] = "**userfree %d";
static const char long_spc633[]  = "user request free function returned error code %d";
static const char short_spc634[] = "**userquery %d";
static const char long_spc634[]  = "user request query function returned error code %d";
static const char short_spc635[] = "**vmsplice %d %s";
static const char long_spc635[]  = "vmsplice failed - errno %d (%s)";
static const char short_spc636[] = "**windows_mutex %s";
static const char long_spc636[]  = "Windows mutex routine failed (%s)";
...
887,55,131,162,888,120,776,806,214,698,
895,156,19,905,897,706,246,245,244,188,
190,191,198,129,147,196,197,189,227,229,
236,234,253,653,18,673,202,201,734,204,
205,815,883,146,203,912,45,293,287,798,
