...
int main(int argc, char **argv)
{
    ...
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nomem", "Job size is larger than %d (%d). "                "Reconfigure the library with --with-ch3-rank-bits=32", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "Job size is larger than %d (%d). "                "Reconfigure the library with --with-ch3-rank-bits=32" );
    }
    /* src/mpi/init/initthread.c */
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**sharpcoll", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**sharpcoll" );
    {
    /* src/mpi/coll/ibcast_osu.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**sharpcoll", "Invalid size of bcast array: must be divisible "                            "by %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "Invalid size of bcast array: must be divisible "                            "by %d" );
    }
    ...
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**sharpcoll", "**sharpcoll %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**sharpcoll %s %d" );
    }
    ...
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**sharpcoll", "coll_tmp_buf out of mem (%d), need %d, "                            "continue without SHARP\n", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "coll_tmp_buf out of mem (%d), need %d, "                            "continue without SHARP\n" );
    }
    ...
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**sharpcoll", "coll_tmp_buf out of mem (%d), need %d, "                            "continue without SHARP", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "coll_tmp_buf out of mem (%d), need %d, "                            "continue without SHARP" );
    }
    /* src/mpi/coll/scatterv.c */
    ...
    /* src/mpi/romio/adio/ad_piofs/ad_piofs_open.c */
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**inet_pton", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**inet_pton" );
    {
    /* src/util/wrappers/mpiu_sock_wrappers.h */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**inet_pton", "**inet_pton %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**inet_pton %s %d" );
    }
    /* src/util/wrappers/mpiu_sock_wrappers.h */
    ...
    /* src/mpid/common/sock/iocp/sock.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**getaddrinfo", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**getaddrinfo" );
    {
    /* src/mpid/common/sock/iocp/sock.c */
    char s1[] = "string1";
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**getaddrinfo", "**getaddrinfo %s %d", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**getaddrinfo %s %d" );
    }
    /* src/mpid/common/sock/iocp/sock.c */
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**cpuaffinity", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**cpuaffinity" );
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_resolve_route error %d after"                    " %d attempts\n", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_resolve_route error %d after"                    " %d attempts\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "Cannot use RDMA CM on rank %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "Cannot use RDMA CM on rank %d" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_connect error %d after %d attempts\n", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_connect error %d after %d attempts\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_reject error: %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_reject error: %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_accept error: %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_accept error: %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "RDMA CM Address error: rdma cma event %d, error %d\n", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "RDMA CM Address error: rdma cma event %d, error %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "RDMA CM Connect error: rdma cma event %d, error %d\n", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "RDMA CM Connect error: rdma cma event %d, error %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
    int i2 = 2;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "RDMA CM Unreachable error: rdma cma event %d, error %d\n", i1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "RDMA CM Unreachable error: rdma cma event %d, error %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_get_cm_event err %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_get_cm_event err %d\n" );
    }
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    ...
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_bind_addr failed: %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_bind_addr failed: %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_listen failed: %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_listen failed: %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "Could not create listen cm_id, "                "rdma_create_id error: %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "Could not create listen cm_id, "                "rdma_create_id error: %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_create_id error %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_create_id error %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_resolve_addr error %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_resolve_addr error %d\n" );
    }
    {
    /* src/mpid/ch3/channels/common/src/rdma_cm/rdma_cm.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "Failed to allocate pd %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "Failed to allocate pd %d\n" );
    }
    ...
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "getifaddrs error %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "getifaddrs error %d\n" );
    }
    {
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_priv.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "rdma_create_event_channel error %d\n", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "rdma_create_event_channel error %d\n" );
    }
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmi_wait", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**pmi_wait" );
    {
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_init.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmi_wait", "**pmi_wait %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**pmi_wait %d" );
    }
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_init.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmi_iallgather_wait", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**pmi_iallgather_wait" );
    {
    /* src/mpid/ch3/channels/mrail/src/gen2/rdma_iba_init.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**pmi_iallgather_wait", "**pmi_iallgather_wait %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**pmi_iallgather_wait %d" );
    }
    ...
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ahtype_putfailed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ahtype_putfailed" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ahtype_putcommit", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ahtype_putcommit" );
    /* src/mpid/ch3/channels/psm/src/psm_entry.c */
    ...
    /* src/mpid/ch3/src/mpid_comm_spawn_multiple.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nomem", "Job size is larger than 32768 (%d). Reconfigure the library with --with-ch3-rank-bits=32", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "Job size is larger than 32768 (%d). Reconfigure the library with --with-ch3-rank-bits=32" );
    }
